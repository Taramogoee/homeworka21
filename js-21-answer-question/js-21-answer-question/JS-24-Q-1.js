...
function createPerson(name, age, profession) {
    ...
    introduce() {
        return 'Hi, my name is ${this.name} Im ${this.age} years old and work as a ${this.profession}';
      }
    };
  
    return person;
}
const johnDoe = createPerson("John Doe", 30, "Web Developer");
console.log(johnDoe.name); // Output: John Doe
console.log(johnDoe.age); // Output: 30
console.log(johnDoe.profession); // Output: Web Developer
console.log(johnDoe.introduce()); // Output: Hi, my name is John Doe. I'm 30 years old and work as a Web Developer.